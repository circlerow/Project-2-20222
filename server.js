...
app.get("/update/exercise/:id", controller.updateExercise)
app.post("/update-exercise", controller.updateExerciseData)
app.get("/admin", controller.adminLogin)
app.get("/admin-create", controller.adminPage)
app.post("/create-exercise", controller.adminData)
app.get("/admin-exercise", controller.adminExercise)
